...
genai.configure(api_key=os.environ.get('GEMINI_API_KEY', 'AIzaSyD_s1a-ZMtv6Q5qFZjuuCuvlmzTqruAtLk'))
...
def documentation():
    ...
    # Flask looks in the 'templates' folder for documentation.html
